...
```
cd existing_repo
git remote add origin https://gitlab.com/juanmarcos/klnx_deveplopment.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/juanmarcos/klnx_deveplopment/-/settings/integrations)
