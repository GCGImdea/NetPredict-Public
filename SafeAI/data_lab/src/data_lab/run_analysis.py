...
from data_lab.config import DATA_PATH, TARGET, THROUGHPUT_LIMS
from data_lab.detection import mad_outliers, benchmark_detectors, score_table
...
def run_single_limit(data_prepared: pd.DataFrame, lim: str):
    ...
    residuals = compute_residuals(X_lim.loc[X_all.index, TARGET], y_predicted)
